...
const bhost = 'https://api.lzj.im/board.php'
const jhost = 'https://cdn.lzj.im/score.php?'
...
// Index
const getToday = (params) => wxRequest(params, bhost)

// Table
//const getTable = (params) => wxRequest(params, host + params.query.action + '&dept=' + params.query.dept + '&name=' + params.query.name)
const getTable = (params) => wxRequest(params, jhost + 'master=' + params.query.action[0] + '&id=' + params.query.action[1])
